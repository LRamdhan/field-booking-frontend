      ...
      <div css={css`width: 100%; height: max-content;`}>
        <Flex justify="center" align="center" vertical css={cardStyle}>
          <Image
            ...
            preview={false}
          />
          <Typography.Title css={css`font-size: 28px; color: var(--text-color); font-weight: 500; margin-top: 15px; margin-bottom: 0;`}>Link Tidak Valid</Typography.Title>
          <Typography.Text align="center" css={css`font-size: 15px; color: var(--secondary-color); padding-top: 14px;`}>Silahkan lakukan reset password kembali</Typography.Text>
