  ...
  return (
    <section css={css`margin-top: 43px;`}>
      <AboutFirstAnimation css={css`display: flex; justify-content: center; align-items: center; flex-direction: column;`}>
        ...
        <p css={css`max-width: 482px; font-size: 18px; font-weight: 500; color: var(--text-color); text-align: center; margin-top: 20px; padding: 0 12px;`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor </p>
